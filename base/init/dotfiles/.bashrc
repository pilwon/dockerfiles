...
# Shell
export CLICOLOR="1"
if [ -f $HOME/.init/scripts/git-prompt.sh ]; then
  source $HOME/.init/scripts/git-prompt.sh
...
# Git
source $HOME/.init/scripts/git-completion.sh

# Z
source $HOME/.init/scripts/z.sh
